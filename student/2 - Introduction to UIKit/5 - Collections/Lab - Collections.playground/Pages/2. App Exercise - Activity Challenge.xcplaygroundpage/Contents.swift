 ...
 */
var walkingChallenges = ["Walk a mile", "Walk 3 miles a day",]
var runningChallenges = ["Run once a week", "Run 5 times a week", ]
...
if committed.isEmpty {
    ...
    print("You have chosen a challenge \(committed[0])")
} else {
