...
let favoriteBook = Book(title: "Moscow", author: "Amor Towles", pages: 380, price: 15.5)
print(favoriteBook)
/*:
...
let a = Laptop(screenSize: 15, repairCount: 1, yearPurchased: 2017)
let b = Laptop(yearPurchased: 2018)
print(a, b)
/*:
...
let myHeight = Height(heightInCentimeters: 171)
print(myHeight)
/*:
