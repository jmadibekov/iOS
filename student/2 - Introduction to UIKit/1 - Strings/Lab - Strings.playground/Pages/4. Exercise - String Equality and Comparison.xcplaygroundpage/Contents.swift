 ...
 */
if nameInCamps.lowercased() == name.lowercased() {
    print("\(nameInCamps.lowercased()) and \(name.lowercased()) are the same.")
} else {
    print("Are not")
}
...
if junior.hasSuffix("Jr.") {
    print("We found a 2nd generation name!")
}
